...
public class MainActivity extends AppCompatActivity {
    ...
    public void newMatch() {  //A game is composed of three matches
        ...
        if(operand2 != 0) {
            ...
            if(correctButton == 0 ) {
                button1.setText(ans+"");
                button2.setText(operand1  + 1+" ");
                button3.setText(operand2  -1+"");
                button4.setText(operand1  + 2+"");
            }
          else if(correctButton== 1 ){
                button1.setText(operand1  + 1+" ");
                button2.setText(ans+ " ");
                ...
                //button1.setText(ans);
                 button1.setText(operand1  + 1+" " );
                button2.setText(operand2 -1+" ");
                button3.setText(operand1 + 2+"");
                button4.setText(ans+ " ");
            }
        }
        else  {
    ...
    public String getInterpretation(int [][]dataFrame,double slope){
       //provide interpretation based on your slope analysis
        ...
        else if(myslope>0 && myslope <0.5) return "your are slow but steady ";
